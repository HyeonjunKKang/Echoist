...
public struct GeocodingSearch: Equatable, Decodable, Sendable {
    public var results: [Result]
    
    public struct Result: Decodable, Equatable, Identifiable, Sendable {
...
public struct Forecast: Decodable, Equatable, Sendable {
    ...
    public struct DailyUnits: Decodable, Equatable, Sendable {
